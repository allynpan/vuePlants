    ...
    <div class="demo">
                ...
                <div class="selfcontainer">
                    ...
                    <div class="textBorder">
                        <h2>温度</h2>
                        <div class="">{{tempeture}}</div>
                        <el-input v-model="divNum" placeholder="" @keypress="changeDiv()"></el-input>
                        <el-button type="primary" @click="changeDiv()">点击进行测试</el-button>
                    </div>
